...
const openings = [
  ...
  { moves: ['d4', 'd5', 'Bf4'], name: 'Accelerated London System' },
  { moves: ['d4', 'd5', 'Bf4', 'c5'], name: 'Accelerated London System, Steinitz Counter-Gambit' },
  ...
  { moves: ['e4', 'e5', 'Nf3', 'Nc6', 'd4', 'Bc4'], name: 'Scotch Gambit' },
  { moves: ['e4', 'e5', 'Nf3', 'Nc6', 'd4', 'Bc4', 'Bb4+'], name: 'Scotch Gambit, London Defence' },
